---
name: hardware
description: Read and control I2C and SPI peripherals on supported Linux boards.
homepage: https://github.com/Sterlites/RDxClaw
...
Most I2C/SPI pins are shared with WiFi on Sterlites boards. You must configure pinmux before use.
